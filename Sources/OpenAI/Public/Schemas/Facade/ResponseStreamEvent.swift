...
public enum ResponseStreamEvent: Codable, Equatable, Sendable {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        // wangqi 2026-06-11: a payload type unknown to our enum (non-standard server) resolves to
        // .unknown so the stream continues safely instead of throwing and aborting decoding.
