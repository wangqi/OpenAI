...
public enum Components {
    ...
    public enum Schemas {
        ...
        // wangqi [2026-03-10]: dropped @frozen and added .unknown so unrecognized content types from
        // non-standard servers never crash; upstream's regenerated cases (incl. reasoningTextContent) kept.
        ...
        public enum OutputContent: Codable, Hashable, Sendable {
            ...
            public init(from decoder: any Swift.Decoder) throws {
                ...
                default:
                    // wangqi 2026-06-11: non-standard servers may emit content types we don't model;
                    // fall back to .unknown so the whole response doesn't fail to decode.
                    self = .unknown
                }
            }
            public func encode(to encoder: any Swift.Encoder) throws {
